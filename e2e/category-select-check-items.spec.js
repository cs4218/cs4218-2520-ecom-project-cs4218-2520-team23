...
test.describe("Category navigation with mocked category creation", () => {
	test("create empty category, verify categories list, populated category, and empty category", async ({ page }) => {
		...
		await page.getByRole("textbox", { name: /enter new category/i }).fill(newCategoryName);
